...
def run_play(task_id: str, cfg: PlayConfig):
  ...
  if isinstance(env_cfg, CaTManagerBasedRlEnvCfg):
    manager = CaTManagerBasedRlEnv
  else:
    manager = ManagerBasedRlEnv
  env = manager(cfg=env_cfg, device=device, render_mode=render_mode)
